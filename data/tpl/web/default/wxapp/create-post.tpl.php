							...
							<div class="form-defalut we7-form">
								<div class="form-group">
									...
									<div class="form-controls col-sm-10">
										<input type="text" name="name" value="<?php  echo $wxapp_info['name'];?>" class="form-control wxapp-name" id="" placeholder="小程序名称">
									</div>
								</div>
								<?php  if(empty($wxapp_info)) { ?>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="form-controls col-sm-1">
										<input type="number" name="version0" min="0" max="100" value="<?php  echo $version_nums['0'];?>" <?php  if(!empty($version_nums)) { ?>disabled<?php  } ?> class="form-control wxapp-version version0">
									</div>
									<div class="form-controls pull-left">
										<p class="form-control-static wxapp-version">.</p>
									</div>
									<div class="form-controls col-sm-1">
										<input type="number" name="version1" min="0" max="100" value="<?php  echo $version_nums['1'];?>" <?php  if(!empty($version_nums)) { ?>disabled<?php  } ?> class="form-control wxapp-version version1">
									</div>
									<div class="form-controls pull-left">
										<p class="form-control-static wxapp-version">.</p>
									</div>
									<div class="form-controls col-sm-1">
										<input type="number" name="version2" min="0" max="100" value="<?php  echo $version_nums['2'];?>" <?php  if(!empty($version_nums)) { ?>disabled<?php  } ?> class="form-control wxapp-version version2">
									</div>
								</div>
								<div class="form-group">
