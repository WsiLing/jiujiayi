...
<div id="js-system-module" ng-controller="installedCtrl" ng-cloak>
	...
	<ul class="we7-page-tab">
		...
		<li><a href="<?php  echo url('system/module/not_installed', array('account_type' => 4))?>" ng-if="isFounder == 1">未安装的应用<span class="color-red">  (<?php  echo $total_uninstalled;?>) </span></a></li>
