  ...
  <ul>
   <?php if(cv('sale.coupon.view')) { ?><li <?php  if($_W['routes']=='sale.coupon') { ?>class="active"<?php  } ?>><a href="<?php  echo webUrl('sale/coupon')?>">优惠券管理</a></li><?php  } ?>
      ...
      <?php if(cv('sale.coupon.send')) { ?>
        <li><a href="<?php  echo webUrl('sale/coupon/sendcoupon')?>">手动发送</a></li>
      <?php  } ?>
      <?php if(cv('sale.coupon')) { ?><li <?php  if($_W['routes']=='sale.coupon') { ?>class="active"<?php  } ?>><a href="<?php  echo webUrl('sale/coupon/sendtask')?>">自动发送</a></li><?php  } ?>
