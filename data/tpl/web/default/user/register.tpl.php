		...
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="<?php  echo $_W['siteroot'];?>">
					<img src="<?php  if(!empty($_W['setting']['copyright']['blogo'])) { ?><?php  echo tomedia($_W['setting']['copyright']['blogo'])?><?php  } else { ?>./resource/images/logo/logo2.png<?php  } ?>" class="pull-left" width="110px" height="35px">
					<span class="version">商城</span>
				</a>
			</div>
		</div>
	</nav>
