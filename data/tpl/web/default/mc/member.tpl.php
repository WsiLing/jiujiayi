...
<form method="post" class="we7-form" id="form1">
			...
			<div class="we7-margin-left">
				...
				<input type="submit" name="submit" class="btn btn-primary btn-submit" value="删除">
			</div>
...
<div id="js-profile-credit" ng-controller="creditCtrl" ng-cloak>
	<table class="table we7-table table-hover vertical-middle">
		...
		<tr ng-repeat="(key, credit) in creditSetting  track by key">
			...
			<td class="pull-right"><a href="javascript:;" class="color-default" ng-click="editCreditName(key)">设置名称</a></td>
		</tr>
	</table>
	...
	<table class="table we7-table table-hover table-form">
		...
		<tr>
			...
			<td class="text-center">
				<a href="javascript:;"  class="color-default" ng-click="editCreditTactics('activity')">更改</a>
			</td>
		</tr>
		<tr>
			<td >交易和支付(余额)</td>
			...
			<td class="text-center">
				<a href="javascript:;"  class="color-default" ng-click="editCreditTactics('currency')">更改</a>
			</td>
		</tr>
	</table>
