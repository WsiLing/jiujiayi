...
<div class="fui-cell-group sm">
    ...
    <div class="fui-cell">
        ...
        <div class="fui-cell-info"></div>
        <div class="fui-cell-remark noremark">&yen; <span class='<?php  if(!$packageid && empty($exchangeOrder)) { ?>goodsprice<?php  } ?>'><?php  if(!empty($exchangeOrder)) { ?><?php  echo $exchangeprice;?><?php  } else { ?><?php  echo number_format($goodsprice,2)?><?php  } ?></span></div>
    </div>
    <?php  if(empty($exchangeOrder)) { ?>
    <?php  if(!$packageid) { ?>
