...
<div class='fui-page order-list-page'>
    ...
    <?php  } else { ?>
    <div id="tab" class="fui-tab fui-tab-danger">
        <a data-tab="tab" style='cursor:pointer' class="external <?php  if($_GPC['status']=='') { ?>active<?php  } ?>" data-status=''>全部</a>
        <a data-tab="tab0" style='cursor:pointer' class="external <?php  if($_GPC['status']=='0') { ?>active<?php  } ?>"  data-status='0'>待付款</a>
        <a data-tab="tab1" style='cursor:pointer' class="external <?php  if($_GPC['status']=='1') { ?>active<?php  } ?>"  data-status='1'>待发货</a>
        <a data-tab="tab2" style='cursor:pointer' class="external <?php  if($_GPC['status']=='2') { ?>active<?php  } ?>"  data-status='2'>待收货</a>
        <a data-tab="tab3" style='cursor:pointer' class="external <?php  if($_GPC['status']=='3') { ?>active<?php  } ?>"  data-status='3'>已完成</a>
    </div>
    <?php  } ?>
